...
<html class="h-full bg-white dark:bg-gray-900">
  ...
  <div class="sm:mx-auto sm:w-full sm:max-w-sm">
    <img src="/assets/icon.png" alt="Your Company" class="mx-auto h-10 w-auto dark:hidden" />
    <img src="/assets/icon.png" alt="Your Company" class="mx-auto h-10 w-auto not-dark:hidden" />
  ...
  <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
    ...
    <p class="mt-10 text-center text-sm/6 text-gray-500 dark:text-gray-400">
      ...
      <a href="#" class="font-semibold text-indigo-600 hover:text-indigo-500 dark:text-indigo-400 dark:hover:text-indigo-300">Sign up.</a>
    </p>
  </div>
</div>
